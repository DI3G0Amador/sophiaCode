 ...
 */
export function getRecommendation(modelName) {
    const normalizedKey = Object.keys(RECOMMENDATIONS).find(k => modelName.toLowerCase().replace(/-/g, '').includes(k.toLowerCase().replace(/-/g, '')));
    if (normalizedKey) {
