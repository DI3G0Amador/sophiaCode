 ...
 */
async function analyzePackageJson(basePath) {
    try {
 ...
 */
async function analyzeFile(basePath, relativePath) {
    ...
    try {
        ...
        while ((match = importRegex.exec(headerText)) !== null) {
            ...
            if (imp && !imp.startsWith('.')) { // Exclude relative local imports
