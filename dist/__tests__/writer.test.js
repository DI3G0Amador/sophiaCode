...
import { checkConfigExist, saveDocumentation, readMapFile, writeMapFile, saveProjectConfig, readProjectConfig, saveRootBridgedFiles } from '../fs/writer.js';
describe('Writer Module (fs/writer.ts)', () => {
    ...
    it('should prepend redirection notice to existing CLAUDE.md and AGENTS.md to preserve existing custom files when selected', async () => {
        ...
        await saveRootBridgedFiles(testWorkspace, '# Claude redirect', '# Agents redirect', ['claude', 'opencode']);
