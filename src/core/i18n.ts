...
> = {
  en: {
    ...
    init_overwrite_warn: '⚠️ A sophiAgents configuration is already present in this directory.',
    ...
    task_error_mvp: '⚠️ No MVP specifications found in "sophiAgents/mvps/".',
    ...
    dev_error_tasks: '⚠️ No planned tasks found under "sophiAgents/tasks/".',
    ...
    dev_no_subtasks: '⚠️ This task does not contain cataloged subtasks.',
    dev_done: 'Completed.',
    ...
    skill_intro: '🛠️ Skills Setup (Automations & MCP)',
  ...
  pt: {
    ...
    init_overwrite_warn: '⚠️ Uma configuração do sophiAgents já está presente neste diretório.',
    init_overwrite_confirm:
    ...
    init_success:
      '🎉 SophiaCode inicializado com sucesso! Contexto gerado na pasta "sophiAgents/".',
    ...
    task_error_mvp: '⚠️ Nenhuma especificação de MVP encontrada em "sophiAgents/mvps/".',
    ...
    dev_error_tasks: '⚠️ Nenhuma tarefa planejada encontrada em "sophiAgents/tasks/".',
    ...
    dev_all_completed:
      '🎉 Excelente! Todas as subtasks desta tarefa foram marcadas como concluídas.',
    ...
    dev_no_subtasks: '⚠️ Esta tarefa não contém subtasks catalogadas.',
    dev_done: 'Concluído.',
    ...
    skill_intro: '🛠️ Configuração de Skills (Automações & MCP)',
    skill_confirm:
